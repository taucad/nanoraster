...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_2798: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_1825: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_1825_4: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_1825_5: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_2813: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_1830: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_1830_3: (a: number, b: number, c: number) => void;
