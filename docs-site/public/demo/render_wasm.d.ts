...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_5086: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_4119: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_4119_4: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_4119_5: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_5101: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_4124: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_4124_3: (a: number, b: number, c: number) => void;
