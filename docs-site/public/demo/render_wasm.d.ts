...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_1800: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_1800_4: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_1800_5: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_2784: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_1805: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_1805_3: (a: number, b: number, c: number) => void;
