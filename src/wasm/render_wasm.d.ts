...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_1833: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_1833_4: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_1833_5: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_2821: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_1838: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_1838_3: (a: number, b: number, c: number) => void;
