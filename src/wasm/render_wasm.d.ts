...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_1963: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_977: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_977_2: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_977_3: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_1980: (a: number, b: number, c: number, d: number) => void;
