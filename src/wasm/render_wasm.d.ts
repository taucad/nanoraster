...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_1845_13: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_1845_14: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_2883: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_2898: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_1849: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_1849_12: (a: number, b: number, c: number) => void;
