...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_1983: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_1016: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_1016_4: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_1016_5: (a: number, b: number, c: number, d: number) => void;
    ...
    readonly __wasm_bindgen_func_elem_1021_3: (a: number, b: number, c: number) => void;
