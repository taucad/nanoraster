...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_1275: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_1275_4: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_1275_5: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_2257: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_1280: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_1280_3: (a: number, b: number, c: number) => void;
