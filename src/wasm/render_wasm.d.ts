...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_2773: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_1804: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_1804_4: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_1804_5: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_2788: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_1809: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_1809_3: (a: number, b: number, c: number) => void;
