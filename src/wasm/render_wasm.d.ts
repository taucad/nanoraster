...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_1849_13: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_1849_14: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_2889: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_2904: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_1853: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_1853_12: (a: number, b: number, c: number) => void;
